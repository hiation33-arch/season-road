...
2. 상세 정보에서 환급 안내 확인
3. 왼쪽 패널 상단 배너 클릭 → 반값 여행 공식 안내 사이트로 이동
...
| 서비스명 | 오퍼레이션 | 활용 기능 |
|---|---|---|
| 국문/영문/중문간체/일문 관광정보 서비스 (Kor·Eng·Chs·JpnService2) | `areaBasedList2` | 계절·지역 기반 관광지 목록 조회 (4개 언어 지원) |
| 국문/영문/중문간체/일문 관광정보 서비스 (Kor·Eng·Chs·JpnService2) | `searchFestival2` | 계절별 축제·행사 정보 조회 |
| 국문/영문/중문간체/일문 관광정보 서비스 (Kor·Eng·Chs·JpnService2) | `detailCommon2` | 장소 상세 정보(이미지, 개요) 조회 |
...
*Season Road — 2026 관광데이터 활용 공모전 출품작*
